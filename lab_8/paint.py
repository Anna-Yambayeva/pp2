...
while running:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONUP:
            if event.button == 1:  # ЛКМ
                ...
                Только rect/circle нужно отрисовывать после предпросмотра
                '''
    ...
    # Предпросмотр: если пользователь «тянет» прямоугольник или круг, то рисуем поверх screen, но не сохраняем в base_layer, пока не отпущена ЛКМ
